...
const initializeDatabase = async () => {
    ...
    `);
        ...
        const productCount = await (0, exports.query)('SELECT count(*) FROM products');
        if (parseInt(productCount.rows[0].count) === 0) {
            ...
            for (const p of productsToSeed) {
                await (0, exports.query)(`INSERT INTO products (name, description, price, image_url, category, availability, is_active) 
                 VALUES ($1, $2, $3, $4, $5, $6, $7)`, [p.name, p.description, p.price, p.image_url, p.category, p.availability, true]);
            }
