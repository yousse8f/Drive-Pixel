...
export const initializeDatabase = async () => {
  try {
    ...
    await query(`CREATE INDEX IF NOT EXISTS idx_cms_pages_status ON cms_pages(status);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_cms_sections_page_id ON cms_sections(page_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_cms_sections_order ON cms_sections("order");`);
    await query(`CREATE INDEX IF NOT EXISTS idx_cms_content_blocks_section_id ON cms_content_blocks(section_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_cms_content_versions_entity ON cms_content_versions(entity_type, entity_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_cms_components_slug ON cms_components(slug);`);

    // =====================================================
    // CRM INDEXES
    // =====================================================
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_customers_email ON crm_customers(email);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_customers_status ON crm_customers(status);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_customers_assigned_to ON crm_customers(assigned_to);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_customers_lead_id ON crm_customers(lead_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_customer_notes_customer_id ON crm_customer_notes(customer_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_activities_customer_id ON crm_activities(customer_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_activities_created_at ON crm_activities(created_at);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_deals_customer_id ON crm_deals(customer_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_deals_stage_id ON crm_deals(stage_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_crm_deals_status ON crm_deals(status);`);

    // =====================================================
    // EMAIL INDEXES
    // =====================================================
    await query(`CREATE INDEX IF NOT EXISTS idx_email_lists_active ON email_lists(is_active);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_list_subscribers_list_id ON email_list_subscribers(list_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_list_subscribers_email ON email_list_subscribers(email);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_list_subscribers_status ON email_list_subscribers(status);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_campaigns_status ON email_campaigns(status);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_campaigns_list_id ON email_campaigns(list_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_send_log_campaign_id ON email_send_log(campaign_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_send_log_status ON email_send_log(status);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_click_tracking_send_log_id ON email_click_tracking(send_log_id);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_email_unsubscribes_email ON email_unsubscribes(email);`);
    ...
    // =====================================================
    await query(`CREATE INDEX IF NOT EXISTS idx_import_jobs_status ON import_jobs(status);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_import_jobs_created_by ON import_jobs(created_by);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_export_jobs_status ON export_jobs(status);`);
    await query(`CREATE INDEX IF NOT EXISTS idx_export_jobs_created_by ON export_jobs(created_by);`);
