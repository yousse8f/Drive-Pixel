...
import { ArrowRight, Globe, Award, Users, Zap, BarChart3, DollarSign, FileCheck, Mail } from 'lucide-react';
import { Button } from '@/components/ui/button';
import Navbar from '@/components/Navbar';
import Footer from '@/components/Footer';

export default function ListPropertyPage() {
  const whyListFeatures = [
    {
      icon: Globe,
      title: 'Maximum Exposure',
      description: 'Your property will be marketed across multiple online platforms to ensure it reaches the widest possible audience of qualified buyers and investors.'
    },
    {
      icon: Award,
      title: 'Professional Marketing',
      description: 'We provide professional listing presentations, digital marketing strategies, and property promotion to position your property competitively in the market.'
    },
    {
      icon: Users,
      title: 'Experienced Agents',
      description: 'Our agents are knowledgeable, tech-savvy, and supported by industry-leading systems to guide you through every step of the selling process.'
    },
    {
      icon: Zap,
      title: 'Virtual Advantage',
      description: 'As a fully virtual brokerage, we eliminate unnecessary overhead and focus on efficiency, speed, and results. This allows us to deliver a streamlined and responsive experience for property owners.'
    }
  ];
  ...
  const listingProcess = [
    {
      ...
      description: 'We analyze market conditions and comparable properties to determine the most effective listing strategy.'
    },
    {
      icon: DollarSign,
      title: 'Strategic Pricing',
      description: 'Accurate pricing helps attract serious buyers and reduces time on the market.'
    },
    {
      icon: FileCheck,
      title: 'Transaction Management',
      description: 'Our paperless transaction system ensures that every step of the process is handled smoothly, securely, and efficiently.'
    }
  ];
      ...
      <section className="relative py-32 text-white">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
            Maximize exposure and deliver results with our powerful virtual platform
          </p>
        </div>
      </section>
