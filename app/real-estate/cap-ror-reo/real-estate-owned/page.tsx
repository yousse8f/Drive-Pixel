...
import { ArrowRight, Mail, Building, TrendingUp, Target, Shield, DollarSign, Home, Clock } from 'lucide-react';
...
export default function RealEstateOwnedPage() {
  const benefits = [
    {
      ...
      description: 'REO properties typically sell below market value'
    },
    {
      icon: Clock,
      title: 'Faster transactions',
      description: 'Streamlined buying process with lender ownership'
    },
    {
      icon: TrendingUp,
      title: 'Investment potential',
      description: 'Opportunity for significant returns with renovation'
    }
  ];
  ...
  const supportServices = [
    {
      ...
      description: 'Expert advice on property improvements'
    },
    {
      icon: Target,
      title: 'Investment analysis',
      description: 'Comprehensive ROI calculations'
    },
    {
      icon: Shield,
      title: 'Due diligence support',
      description: 'Thorough property inspection assistance'
    }
  ];
  ...
  const features = [
    {
      ...
      description: 'Properties owned by lending institutions'
    },
    {
      title: 'Discounted Pricing',
      description: 'Below-market value opportunities'
    },
    {
      title: 'Quick Closing',
      description: 'Faster transaction processes'
    },
    {
      title: 'Renovation Potential',
      description: 'Opportunity to add value through improvements'
    }
  ];
  ...
  const process = [
    {
      ...
      description: 'Locate suitable REO properties'
    },
    {
      title: 'Due Diligence',
      description: 'Thorough property inspection and analysis'
    },
    {
      title: 'Offer Submission',
      description: 'Competitive offer preparation'
    },
    {
      title: 'Closing Support',
      description: 'Assistance through the closing process'
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <DynamicPageContent pagePath="/real-estate/cap-ror-reo/real-estate-owned" fallbackContent={
        <section className="relative py-32 text-white">
          ...
          <div className="container-custom text-center relative z-10">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">REAL ESTATE OWNED (REO)</h1>
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
              Repossessed properties offering discounted investment opportunities
            </p>
          </div>
        </section>
      } />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="space-y-6 mb-12">
            <p className="text-lg text-[#4f2c33] leading-relaxed text-center max-w-4xl mx-auto">
              REO properties are repossessed by lenders after foreclosure and offer discounted investment opportunities. These properties provide unique chances for investors to acquire real estate below market value.
            </p>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Expert Renovation Advice</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Our renovation guidance helps you maximize the value of REO properties through strategic improvements. We provide expert advice on cost-effective renovations that increase property value and market appeal.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Comprehensive ROI Calculations</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Our investment analysis provides detailed ROI calculations to help you make informed decisions. We evaluate potential returns, renovation costs, and market conditions to ensure profitable investments.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Thorough Property Inspection</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Our due diligence support includes comprehensive property inspections to identify potential issues and renovation needs. We ensure you have all the information needed to make sound investment decisions.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-midnight-blue text-white">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black">Find Discounted Investment Opportunities</h2>
