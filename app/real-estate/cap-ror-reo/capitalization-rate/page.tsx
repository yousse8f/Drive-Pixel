...
import { ArrowRight, Mail, Calculator, Target, TrendingUp, Shield, Building, Users, DollarSign } from 'lucide-react';
import { Button } from '@/components/ui/button';
import Navbar from '@/components/Navbar';
import Footer from '@/components/Footer';
import DynamicPageContent from '@/components/DynamicPageContent';

export default function CapitalizationRatePage() {
  const propertyTypes = [
    {
      icon: Building,
      title: 'Residential',
    ...
    },
    {
      icon: Target,
      title: 'Vacant Land',
      value: 'High but speculative',
      description: 'Land for development with higher risk/reward'
    }
  ];
  ...
  const benefits = [
    {
      icon: TrendingUp,
      title: 'Evaluating Property Profitability',
      description: 'Compare investments easily with standardized metrics'
    },
    {
      icon: Shield,
      title: 'Risk Assessment',
      description: 'Higher Cap Rates = higher risk; Lower Cap Rates = safer investments'
    },
    {
      icon: DollarSign,
      title: 'Market Indicator',
      description: 'Reflects buyer vs. seller market conditions'
    }
  ];
  ...
  const supportServices = [
    {
      ...
      description: 'Professional cap rate calculations and analysis'
    },
    {
      icon: Target,
      title: 'Market insights',
      description: 'Current market trends and cap rate benchmarks'
    },
    {
      icon: Building,
      title: 'Tailored investment strategy',
      description: 'Customized strategies based on cap rate analysis'
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <DynamicPageContent pagePath="/real-estate/cap-ror-reo/capitalization-rate" fallbackContent={
        <section className="relative py-32 text-white">
          ...
          <div className="container-custom text-center relative z-10">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">CAPITALIZATION RATE</h1>
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
              Key metric for evaluating income-producing properties and estimating potential ROI
            </p>
          </div>
        </section>
      } />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="space-y-6 mb-12">
            <p className="text-lg text-[#4f2c33] leading-relaxed text-center max-w-4xl mx-auto">
              Capitalization Rate (Cap Rate) is a key metric for evaluating income-producing properties and estimating potential ROI. Understanding cap rates helps investors make informed decisions about real estate investments.
            </p>
          </div>
          ...
          <div className="space-y-6 mb-16">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Cap Rate Formula</h3>
                <div className="bg-midnight-blue text-white p-6 rounded-lg max-w-md mx-auto">
                  <p className="text-xl font-mono text-center">
                    Cap Rate = (Net Operating Income ÷ Current Market Value) × 100
                  </p>
                </div>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Example: NOI $50,000 / Property Value $1,000,000 × 100 = 5%
                </p>
              </div>
            </div>
          </div>
            ...
            {propertyTypes.map((type) => {
              ...
              return (
                <div key={type.title} className="flex flex-col items-center gap-4 rounded-lg border border-muted-indigo/30 bg-light-beige px-6 py-8 text-center shadow-[0_12px_0_0_rgba(45,58,107,0.3)] hover:-translate-y-2 transition-transform min-h-[280px]">
                  ...
                  <div className="text-2xl font-bold text-royal-purple">{type.value}</div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Professional Cap Rate Analysis</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Our expert analysis provides accurate cap rate calculations and comprehensive property evaluations. We use industry-standard methods to ensure reliable investment metrics.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Current Market Trends</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Our market insights provide current cap rate benchmarks and trends across different property types and locations. Stay informed about market conditions and investment opportunities.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Customized Investment Strategy</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Our tailored investment strategies are based on comprehensive cap rate analysis to help you achieve your financial goals. We customize approaches to match your risk tolerance and investment objectives.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-midnight-blue text-white">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black">Get Expert Cap Rate Analysis</h2>
