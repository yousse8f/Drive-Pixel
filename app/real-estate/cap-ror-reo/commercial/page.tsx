...
export default function CommercialPage() {
  const propertyTypes = [
    ...
    },
    {
      icon: Building,
      title: 'Retail spaces',
      description: 'Shopping centers and storefronts'
    },
    {
      icon: Building,
  ...
  const features = [
    {
      ...
      description: 'Stable tenant relationships and income'
    },
    {
      icon: TrendingUp,
      title: 'Higher ROI',
      description: 'Greater returns compared to residential'
    },
    {
      icon: Shield,
      title: 'Tenant responsibility (NNN leases)',
      description: 'Tenants cover maintenance, insurance, taxes'
    }
  ];
  ...
  const benefits = [
    {
      title: 'Stable Income',
      description: 'Consistent rental cash flow'
    },
    {
      title: 'Professional Tenants',
      description: 'Business tenants with stable operations'
    },
    {
      title: 'Longer Leases',
      description: 'Reduced turnover and vacancy'
    },
    {
      title: 'Triple Net Leases',
      description: 'Lower operating costs for owners'
    }
  ];
  ...
  const investment = [
    {
      ...
      description: 'Commercial real estate market trends'
    },
    {
    ...
    },
    {
      ...
      description: 'Review of existing and potential leases'
    },
    {
      title: 'ROI Projections',
      description: 'Detailed return calculations'
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <DynamicPageContent pagePath="/real-estate/cap-ror-reo/commercial" fallbackContent={
        <section className="relative py-32 text-white">
          ...
          <div className="container-custom text-center relative z-10">
            ...
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
              Office buildings, retail spaces, and industrial facilities offering stable rental income
            </p>
          </div>
        </section>
      } />
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="space-y-6 mb-12">
            <p className="text-lg text-[#4f2c33] leading-relaxed text-center max-w-4xl mx-auto">
              Commercial real estate includes office buildings, retail spaces, and industrial facilities, offering stable rental income. These properties feature long-term leases, higher ROI, and tenant responsibility through NNN leases.
            </p>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Stable Tenant Relationships</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Long-term leases provide stable tenant relationships and consistent income. Commercial tenants typically sign leases for 3-10 years, reducing turnover and vacancy risks.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Greater Returns Potential</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  Commercial properties typically offer higher ROI compared to residential investments. The combination of stable income and appreciation potential creates strong investment returns.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-light-beige border border-muted-indigo/30 rounded-lg p-8 shadow-[0_12px_0_0_rgba(45,58,107,0.3)]">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-bold text-midnight-blue">Triple Net Lease Benefits</h3>
                <p className="text-lg text-muted-indigo leading-relaxed max-w-3xl mx-auto">
                  NNN leases place responsibility for maintenance, insurance, and property taxes on tenants. This structure reduces operating costs and provides predictable net income for property owners.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-midnight-blue text-white">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black">Explore Commercial Real Estate</h2>
