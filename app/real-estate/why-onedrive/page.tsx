        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {uniqueFeatures.map((feature) => {
              ...
              return (
                <div key={feature.title} className="flex flex-col items-center gap-4 rounded-lg border border-[#c3868b] bg-gradient-to-b from-[#ffe1e1] to-[#ffc5c9] px-6 py-8 text-center shadow-[0_12px_0_0_#d37377] hover:-translate-y-2 transition-transform min-h-[240px]">
                  ...
                  <h3 className="text-xl font-bold text-[#33202b] leading-tight">{feature.title}</h3>
                  <p className="text-sm text-[#4f2c33] leading-relaxed break-words flex-1">{feature.description}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {betterWayFeatures.map((feature) => {
              const Icon = feature.icon;
              return (
                <div key={feature.title} className="flex flex-col items-center gap-4 rounded-lg border border-[#c3868b] bg-gradient-to-b from-[#ffe1e1] to-[#ffc5c9] px-6 py-8 text-center shadow-[0_12px_0_0_#d37377] hover:-translate-y-2 transition-transform min-h-[220px]">
                  <div className="h-20 w-20 rounded-full bg-gradient-to-b from-[#17b58f] to-[#0e8f6a] shadow-[inset_0_-6px_0_rgba(0,0,0,0.18)] flex items-center justify-center text-white flex-shrink-0">
                    <Icon className="h-10 w-10" />
                  </div>
                  <h3 className="text-xl font-bold text-[#33202b] leading-tight">{feature.title}</h3>
          ...
          <div className="rounded-lg border border-[#c3868b] bg-gradient-to-b from-[#ffe1e1] to-[#ffc5c9] px-8 py-10 shadow-[0_12px_0_0_#d37377] mb-16">
            <div className="space-y-6">
              ...
              <p className="text-lg text-[#4f2c33] leading-relaxed font-semibold">
      ...
      <section className="py-16 bg-[#080f24] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <p className="text-lg text-white/80 leading-relaxed">
            Are you ready to improve your real estate career? Join our industry-leading virtual brokerage and avoid the 9-to-5 grind. Use our expertise and help to close transactions faster and work smarter, not harder.
          </p>
          <p className="text-lg text-white/80 leading-relaxed">
