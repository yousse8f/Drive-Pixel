  ...
  const services = [
    {
      ...
      description: 'Build apps that work seamlessly across iOS and Android.'
    },
    {
      icon: Palette,
      title: 'Smooth UI/UX design',
      description: 'Intuitive interfaces designed for great user experiences.'
    },
    {
      icon: Bell,
      title: 'Push notifications & updates',
      description: 'Keep users engaged with timely notifications and updates.'
    },
    {
      icon: Database,
      title: 'Integration with backend services',
      description: 'Connect your app with APIs and backend systems reliably.'
    },
    {
      icon: Store,
      title: 'App store deployment',
      description: 'Publish your app on the App Store and Google Play.'
    }
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 md:py-24 bg-midnight-blue">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black text-white">Get in touch to develop your mobile app!</h2>
