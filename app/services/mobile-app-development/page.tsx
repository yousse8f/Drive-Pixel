...
import { ArrowRight, Smartphone, Palette, Bell, Database, Store } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <ServiceHero 
        ...
        description="Developing intuitive and efficient mobile applications to enhance user engagement."
      />
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">Cross-platform development</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">Smooth UI/UX design</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">Push notifications & updates</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">Integration with backend services</h3>
              <p className="text-gray-600">Connect your app with APIs and backend systems reliably.</p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center justify-center h-16 w-16 rounded-lg bg-[#10b981]/10 mb-6">
                <Store className="h-8 w-8 text-[#10b981]" />
              </div>
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">App store deployment</h3>
