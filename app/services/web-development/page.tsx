  ...
  const services = [
    {
      ...
      description: 'Tailored designs that reflect your brand.'
    },
    {
      icon: Blocks,
      title: 'CMS integration (WordPress, Joomla…)',
      description: 'Seamless integration with popular CMS platforms.'
    },
    {
      icon: Search,
    ...
    },
    {
      ...
      description: 'Robust e-commerce solutions for your online store.'
    },
    {
      icon: Wrench,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 md:py-24 bg-midnight-blue">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black text-white">Contact us today to start building your website!</h2>
