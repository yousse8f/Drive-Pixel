...
import { ArrowRight, Palette, Blocks, Search, ShoppingCart, Wrench } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <ServiceHero 
        ...
        description="We build websites that are responsive, fast, and tailored to your business needs."
      />
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">Custom design & UI/UX</h3>
              <p className="text-gray-600">Tailored designs that reflect your brand.</p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center justify-center h-16 w-16 rounded-lg bg-[#10b981]/10 mb-6">
                <Blocks className="h-8 w-8 text-[#10b981]" />
              </div>
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">CMS integration (WordPress, Joomla…)</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">SEO-friendly architecture</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">E-commerce functionality</h3>
              <p className="text-gray-600">Robust e-commerce solutions for your online store.</p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center justify-center h-16 w-16 rounded-lg bg-[#10b981]/10 mb-6">
                <Wrench className="h-8 w-8 text-[#10b981]" />
              </div>
              <h3 className="text-xl font-bold text-[#1a1f3a] mb-3">Maintenance & support</h3>
