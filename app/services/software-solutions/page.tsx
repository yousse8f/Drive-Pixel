...
export default function SoftwareSolutionsPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Scalable solutions hosted on the cloud.'
    },
    {
      icon: Plug,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 md:py-24 bg-midnight-blue">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black text-white">Request a consultation for your software needs!</h2>
