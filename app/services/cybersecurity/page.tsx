    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-900 to-primary-700 text-white">
        <div className="container-custom text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Cybersecurity Services – Protect Your Business</h1>
          <p className="text-xl text-primary-100 max-w-3xl mx-auto">
            Ensure the safety and integrity of your network, data, and digital assets.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Network monitoring & threat detection</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Data encryption & protection</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Compliance & audits</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Backup & disaster recovery</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Security training for staff</h3>
