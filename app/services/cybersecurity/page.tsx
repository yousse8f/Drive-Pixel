  ...
  const services = [
    {
      ...
      description: 'Continuous monitoring to detect threats early and protect your infrastructure.'
    },
    {
      icon: Lock,
      title: 'Data encryption & protection',
      description: 'Secure your data with advanced encryption standards and protection protocols.'
    },
    {
      icon: FileCheck,
    ...
    },
    {
      ...
      description: 'Prepare for the unexpected with robust recovery plans and backup solutions.'
    },
    {
      icon: GraduationCap,
      title: 'Security training for staff',
      description: 'Empower your team with cybersecurity knowledge and best practices.'
    }
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 md:py-24 bg-midnight-blue">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black text-white">Secure your business today!</h2>
