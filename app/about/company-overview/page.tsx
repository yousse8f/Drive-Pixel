    ...
    <div className="min-h-screen flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex flex-col items-center gap-4 rounded-lg border border-muted-indigo/30 bg-light-beige px-6 py-8 text-center shadow-[0_12px_0_0_rgba(45,58,107,0.3)] hover:-translate-y-2 transition-transform relative">
              <div className="flex flex-col items-center gap-4 flex-1">
                ...
                <h3 className="text-xl font-bold text-midnight-blue">End-to-end IT services</h3>
                <p className="text-sm text-muted-indigo leading-relaxed">Web, Mobile, Software, and Cybersecurity delivered from one trusted team.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-muted-indigo/30 bg-light-beige px-6 py-8 text-center shadow-[0_12px_0_0_rgba(45,58,107,0.3)] hover:-translate-y-2 transition-transform relative">
              <div className="flex flex-col items-center gap-4 flex-1">
                ...
                <h3 className="text-xl font-bold text-midnight-blue">Marketing automation & CRM integration</h3>
                <p className="text-sm text-muted-indigo leading-relaxed">Connect leads, pipelines, and campaigns to streamline growth and customer engagement.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-muted-indigo/30 bg-light-beige px-6 py-8 text-center shadow-[0_12px_0_0_rgba(45,58,107,0.3)] hover:-translate-y-2 transition-transform relative">
              <div className="flex flex-col items-center gap-4 flex-1">
                ...
                <h3 className="text-xl font-bold text-midnight-blue">E-commerce stores</h3>
                <p className="text-sm text-muted-indigo leading-relaxed">Complete product/service management, payments, inventory, and scalable storefront experiences.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-muted-indigo/30 bg-light-beige px-6 py-8 text-center shadow-[0_12px_0_0_rgba(45,58,107,0.3)] hover:-translate-y-2 transition-transform relative">
              <div className="flex flex-col items-center gap-4 flex-1">
                ...
                <h3 className="text-xl font-bold text-midnight-blue">Creative solutions</h3>
                <p className="text-sm text-muted-indigo leading-relaxed">Branding, graphics, and screen-print design crafted with pixel-perfect attention to detail.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-24 bg-midnight-blue">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-black text-white">Let's build something reliable and scalable.</h2>
